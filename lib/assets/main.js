...
export function init(ctx, args) {
  ...
  figCaptionTitle.appendChild(document.createTextNode(args.title));
  ...
  for (let s of args.stacks) {
    ...
    if (s.y_axis) {
      ...
      yaxisLabel.appendChild(document.createTextNode(s.y_axis));
      yaxisLabel.classList.add("axis-y-label");
